...
parser.add_argument('--out_path', type=str, default='multifieldqa_zh/lumberchunker.json', help='Output directory path')
...
with open('tmp_cleandata/multifieldqa_zh.json', 'r', encoding='utf-8') as file:  
...
# CUDA_VISIBLE_DEVICES=1 nohup python chunk_lumberchunker.py >> multifieldqa_zh/lumberchunker.log 2>&1 &
